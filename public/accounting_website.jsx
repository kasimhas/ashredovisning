  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        <img src="/ash_logo.png" alt="ASH Redovisning" style={{ height: 48, width: "auto" }} />
      </div>
...
// --- TJÄNSTER ---
const services = [
  { icon: "📒", image: "/lopande_bokforing.png", title: "Löpande bokföring", desc: "Vi sköter din löpande bokföring noggrant och effektivt, alltid i tid och med full koll." },
  { icon: "📊", image: "/bokslut.png", title: "Bokslut & årsredovisning", desc: "Professionell upprättning av bokslut och årsredovisning som uppfyller alla krav." },
  { icon: "🧾", image: "/radgivning.png", title: "Skatterådgivning", desc: "Optimera din skattesituation med strategisk rådgivning anpassad till ditt företag." },
  { icon: "💼", image: "/lonehantering.png", title: "Lönehantering", desc: "Komplett löneadministration — löner, semester, arbetsgivaravgifter och rapportering." },
  { icon: "🚀", image: "/radgivning.png", title: "Företagsrådgivning", desc: "Strategisk vägledning för tillväxt, struktur och finansiella beslut som tar dig framåt." },
];

function ServiceCard({ icon, image, title, desc, delay }) {
...
function Tjanster() {
  return (
    <section id="tjanster" style={{
      background: BLUE, padding: "100px 48px"
    }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ display: "flex", gap: 80, alignItems: "center" }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <FadeIn delay={0.45}>
              <div style={{
                background: BLUE, borderRadius: 20, padding: "24px 28px",
                border: "1.5px solid rgba(255,255,255,0.1)"
              }}>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: "rgba(255,255,255,0.9)", lineHeight: 1.6, marginBottom: 16, fontStyle: "italic" }}>
                  "ASH Redovisning har gjort det möjligt för oss att skala utan ekonomisk stress. Fantastiskt team!"
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 700, color: "white" }}>Anna Lindqvist</div>
                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "rgba(255,255,255,0.6)" }}>VD, TechStart AB</div>
                  </div>
                </div>
              </div>
            </FadeIn>
    ...
    <section id="kontakt" style={{ background: "#0d0d1a", padding: "100px 48px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 60, alignItems: "flex-start" }}>
          {/* Form */}
          <FadeIn delay={0.1} className="" style={{ flex: 1.2 }}>
            <div style={{ flex: "1.2" }}>
              {sent ? (
                <div style={{
          ...
          <FadeIn delay={0.2}>
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 20 }}>
              {[
                ...
                { icon: "📍", label: "Adress", value: "Stureplan 4, 114 35 Stockholm" },
              ].map((c, i) => (
                <div key={i} style={{
              ...
              <div style={{
                ...
                background: "rgba(20,55,255,0.08)", border: "1.5px solid rgba(255,255,255,0.07)",
                display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12
              }}>
                <div style={{ fontSize: 36 }}>🗺️</div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.4)" }}>Stureplan 4, Stockholm</div>
                <div style={{
                  fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 600,
                  color: BLUE, cursor: "pointer",
                  background: "rgba(20,55,255,0.15)", padding: "6px 16px", borderRadius: 100,
                  border: "1px solid rgba(20,55,255,0.3)"
                }}>
                  Öppna i Google Maps →
                </div>
              </div>
...
const faqs = [
  ...
  { q: "Måste jag skriva långt avtal?", a: "Nej. Vi har enkel uppsägningstid och inga krångliga bindningstider." },
  ...
  return (
    <footer style={{ background: "#080810", padding: "40px 48px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <img src="/ash_logo.png" alt="ASH Redovisning" style={{ height: 40, width: "auto", filter: "brightness(0) invert(1)" }} />
        </div>
